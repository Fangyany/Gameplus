...
def main(args):
    ...
    # begin testing
    build_simulation(experiment_name, planner, scenarios[3:], output_dir, simulation_dir, metric_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_name', default='closed_loop_reactive_agents', help='experiment name')
    parser.add_argument('--data_path', type=str, default='/data/fyy/GameFormer-Planner/nuplan/dataset/data/cache/nuplan-v1.1_test/data/cache/test')
    parser.add_argument('--map_path', type=str, default='/data/fyy/GameFormer-Planner/nuplan/dataset/maps')
    parser.add_argument('--model_path', type=str, default='training_log/Exp_e40_dual/model_epoch_28_valADE_1.2955.pth')
