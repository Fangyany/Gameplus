...
from GameFormer.predictor_dual_fusion import GameFormer
...
if __name__ == "__main__":
    ...
    parser.add_argument('--name', type=str, help='log name (default: "Exp1")', default="Exp_fusion_multi_nuplan")
    ...
    parser.add_argument('--train_epochs', type=int, help='epochs of training', default=60)
