...
class Decoder(nn.Module):
    def __init__(self, neighbors=10, modalities=6, levels=3):
        ...
        self.feature_fusion_multihead = FeatureFusionMultiHeadAttention(feature_size=256, num_heads=8)
    ...
    def forward(self, encoder_outputs):
        ...
        attention_output = self.feature_fusion_multihead(combined_feature_tensors) 
        att_content, predictions, scores = self.att_predictor(current_states, attention_output)
